...
const ProductsPreview = () => {
  ...
  return (
    <section className='w-full py-30 overflow-hidden flex flex-col items-center gap-8 justify-center'>
        ...
        <div className="mt-6 w-[80%] overflow-visible py-2 group/cards">
